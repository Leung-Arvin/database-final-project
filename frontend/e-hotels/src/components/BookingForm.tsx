...
import type { Room, Hotel, Customer } from '../types'
...
export default function BookingForm({ room, hotel, onClose, filters, currentCustomer }: BookingFormProps) {
        ...
        <div className="p-6">
          ...
          {bookingSuccess ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-500 mt-2">Check your email for confirmation details.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={3}
                  placeholder="e.g., extra pillows, late check-in, etc."
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
